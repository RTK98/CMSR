...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jul 26, 2023 at 06:39 AM
...
(5, 'APP202307254857', 1, 1, '2023-07-26', 15, '1', 1, NULL, NULL, NULL),
(6, 'APP202307257667', 1, 1, '2023-07-27', 26, '1', 1, NULL, NULL, NULL);
...
INSERT INTO `customervehicles` (`vehicleId`, `CustomerID`, `VehicleType`, `VehicleBrand`, `VehicleModel`, `VehicleImage`, `registerLetter`, `RegistrationNo`) VALUES
(1, 1, 1, NULL, 36, '64bf7c9dd35e44.18750254.jpg', 'CCA', '999');
...
(18, 6, 1, '2023-07-25', 5, 1),
(19, 6, 2, '2023-07-25', 5, 1),
(20, 6, 3, '2023-07-25', 5, 1),
(21, 6, 4, '2023-07-25', 5, 1);
...
CREATE TABLE IF NOT EXISTS `job_cards` (
  ...
  `JobCardCost` double(10,2) NOT NULL DEFAULT '0.00',
  `JobCardPrice` double(10,2) NOT NULL DEFAULT '0.00',
  `Status` int(1) NOT NULL,
  `AddUser` int(11) NOT NULL,
  `AddDate` date NOT NULL,
...
INSERT INTO `job_cards` (`id`, `JobCardNo`, `JobCardType`, `AppointmentId`, `Inspectionid`, `empId`, `AppDate`, `AppointmentNo`, `InspectionNo`, `CustomerId`, `VehicleNo`, `CustomerNo`, `timeslotidappointment`, `JobCardCost`, `JobCardPrice`, `Status`, `AddUser`, `AddDate`, `AddTime`, `UpdateUser`, `UpdateDate`, `UpdateTime`) VALUES
(1, 'JCS202307258886', 1, 4, NULL, 8, '2023-07-25', 'APP202307253253', NULL, 1, '1', 703966282, 13, 0.00, 0.00, 2, 2, '2023-07-25', '19:37:00', 8, '2023-07-25', '23:23:00'),
(2, 'JCS202307259214', 1, 6, NULL, 8, '2023-07-27', 'APP202307257667', NULL, 1, '1', 703966282, 26, 0.00, 0.00, 1, 2, '2023-07-25', '23:30:00', NULL, NULL, NULL),
(3, 'JCS202307259214', 1, 6, NULL, 8, '2023-07-27', 'APP202307257667', NULL, 1, '1', 703966282, 26, 0.00, 0.00, 2, 2, '2023-07-25', '23:30:00', 8, '2023-07-25', '23:32:00');
...
(3, 'Toyota 10W 15W 5L', 1, 1, 'Engine Oil', 5, 0, 5, NULL, 0, 0, 1, 0, NULL, NULL, NULL, NULL);
...
INSERT INTO `tasks` (`TaskId`, `Appointment_id`, `Job_cardId`, `Job_cardNo`, `vehicleId`, `InspectionId`, `emp_id`, `AppDate`, `TimeSlotId`, `AddUser`, `AddDate`, `AddTime`, `UpdateUser`, `UpdateDate`, `UpdateTime`, `Status`) VALUES
(1, 4, 1, 'JCS202307258886', 1, NULL, 8, '2023-07-25', 2, 13, '2023-07-25', '19:37', 8, '2023-07-25', '23:23:00', 2);
...
(17, 'Mrs.', '982130111V64ba748487d402.91542708.png', 'BAWART', 'Kumara', 'rajindratharindwqwqwqwqwu@gmail.com', '719855e8f4ebd94341277b0b0d50b75c5187133f', 'inspectionOfficer', 1, '134', 'Grama Sanwaradana Lane', 'Kottawa Road', 2, 11, 769, '1', '982130111V', '1998-07-31', 1, 779200489, NULL, 1, '2023-07-21', NULL, NULL);
