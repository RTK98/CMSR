<nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
    <div class="position-sticky pt-3 sidebar-sticky">
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?= SYSTEM_PATH ?>appointments/viewAppointment.php">
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?= SYSTEM_PATH ?>timSlots/ViewTimeSlots.php">
                    <span data-feather="file" class="align-text-bottom"></span>
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?= SYSTEM_PATH ?>user/employee/viewEmp.php">
                    <span data-feather="users" class="align-text-bottom"></span>
                    Employee Management
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="<?= SYSTEM_PATH ?>user/customer/viewUser.php">
                    <span data-feather="users" class="align-text-bottom"></span>
                    User Management
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="<?= SYSTEM_PATH ?>user/supplier/viewSupplier.php">
                    <span data-feather="users" class="align-text-bottom"></span>
                    Supplier Management
                </a>
            </li>
