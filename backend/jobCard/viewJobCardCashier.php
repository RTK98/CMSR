    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <div class="btn-toolbar mb-2 mb-md-0">
            <div class="btn-group me-2">
                <a href="<?= SYSTEM_PATH ?>jobCard/viewJobCardCashierDone.php" class="btn btn-sm btn-dark">Paid Job Cards</a>
            </div>
        </div>
    </div>
    <h2>Job Card List</h2>
                            ...
                            <?php if ($showPaidButton) { ?>
                                <td>
                                    <form method='post' action="<?= htmlspecialchars($_SERVER['PHP_SELF']); ?>" >
                                        ...
                                        <input type="hidden" name="AppointmentId" value="<?= @$row['AppointmentId'] ?>">
                                        <input type="hidden" name="InspectionNo" value="<?= @$row['Inspectionid'] ?>">
                                        <button type="submit" name="action" value="edit" class="btn btn-sm btn-dark">Paid</button>
                                    </form>
                                </td>
                            <?php } ?>
                        </tr>
