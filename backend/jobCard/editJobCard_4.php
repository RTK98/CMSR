            ...
            <div class="col-md-4">
                <div class="card">
                    ...
                    <div class="col-md-12">
                        <?php
                        extract($_POST);
                        if ($_SERVER['REQUEST_METHOD'] === "POST" && @$action == 'edit' || $_SERVER['REQUEST_METHOD'] === "POST" && @$action == 'addrepair' || $_SERVER['REQUEST_METHOD'] === "POST" && @$action == 'removeProduct') {
                            $JobCardsInspetionId;
                            $jobCardsRepairId;
                            $db = dbconn();
...
//                        print_r($repairData);
                            ...
                            $db = dbConn();
                            $sqlorders = "INSERT INTO orders(orderNo, InspectionNo,JobCardNo, CustomerName,VehicleNo,AddDate,AddUser,Status) VALUES ('$OrderNo','$JobCardsInspetionId','$jobCardsRepairId','$customerId','$VehicleId','$AddDate','$addeduser','1')";
