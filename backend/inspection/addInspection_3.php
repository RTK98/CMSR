...
//            }
            ...
            if (empty($messages)) {
                ...
                $sql = "INSERT INTO inspections(VehicleNo,InspectionNo,CustomerName,Millege,AddUser,AddDate,Status )VALUES ('$Vehicle','$InspectionNo', '$CustomerId', '$Millege', '$AddUser','$AddDate','1')";
                print_r($sql);
                $db->query($sql);
