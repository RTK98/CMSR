...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    ...
    if ($_SERVER['REQUEST_METHOD'] === "POST" && @$action == 'add') {
        ...
        . "('$StockId','$CatergoryName','$ProductId','$SerialNo','$BatchId','$PoId','$supplierId','$Cost','$SalePrice','4','$addeduser','$adddate')";
        $db->query($sqlExpire);

         $sqlUpdateStock = "UPDATE stockitems SET Status='4', UpdateUser='$addeduser',UpdateDate='$adddate' WHERE StockId='$StockId' ";
                                        ...
                                        <td>
                                            <?php if ($showButtonMnf) { ?>
                                                <form method='post' action="<?= htmlspecialchars($_SERVER['PHP_SELF']); ?>">
                                                    ...
                                                    <button type="submit" name="action" value="add" class="btn btn-sm btn-primary" onclick="return confirm('Are you sure you want to mark as Expire this item?')">Manufacture Damage</button>
                                                </form>
                                            </td>
                                        <?php }
                                        ?>
