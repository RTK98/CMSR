...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    ...
    <div id="report">
        <div class="table-responsive" style="border:1px solid black">
            <?php
            $db = dbconn();
            $sql = "SELECT * FROM catergories WHERE CatergoryStatus='0'";
                            ...
                            <tr style="font-weight:bold;">
                                ...
                                <td>
                                    <form method='post' action="delete.php">
                                        ...
                                        <button type="submit" name="action" value="delete" class="btn btn-am" style="background-color: #0D98BA; color:white; border-color: white;">Active</button>
                                    </form>
