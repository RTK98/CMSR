...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <div class="btn-toolbar mb-2 mb-md-0">
            ...
            <div class="btn-group me-2">
                <a href="<?= SYSTEM_PATH ?>reports/admin/ActiveEmployees.php" class="btn btn-sm btn-dark">Active Employee</a>
            </div>
        </div>
    </div>
    ...
    <h2>Accounts Department Employee Report</h2>
    <?php
    ...
    <div class="table-responsive">
        ...
        $sql = "SELECT u.UserId,u.UserImage,u.Status,u.UserRole,u.NIC,u.FirstName,u.LastName,u.HouseNo,u.Lane,u.Street,u.Email,u.Gender,dep.DepartmentName,pro.ProvinceName,dis.DistrictName,ci.name_en FROM users u "
                ...
                . "WHERE u.UserRole<>'admin' AND u.Status='1' AND u.depId='3';";
        $result = $db->query($sql);
        ?>
