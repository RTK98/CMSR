...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <div class="btn-toolbar mb-2 mb-md-0">
            ...
            <div class="btn-group me-2">
                <a href="<?= SYSTEM_PATH ?>reports/admin/AllSuppliers.php" class="btn btn-sm btn-dark">Activated Suppliers</a>
            </div>
        </div>
    </div>
    ...
    <h2>Non Activated Suppliers Report</h2>
    <div class="table-responsive">
        <?php
        $db = dbconn();
        $sql = "SELECT SupplierId,SupplierName,ContactNo,email,Status FROM supplier WHERE Status='o'";
