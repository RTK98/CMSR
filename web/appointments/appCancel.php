...
//                    print_r($_POST);
                    ...
                    if ($_SERVER['REQUEST_METHOD'] === "POST" && @$action == 'add') {
                        ...
                        if (empty($messages)) {
                            $db = dbConn();
                             $sqlCancelReason = "INSERT INTO appointmentcanceled(AppCanceledId, Reason,AddCustomer,AddCustomerDate) VALUES ('$appointmentId','$CancelReason','$addeduser','$adddate')";
                            ...
                            echo $vehicleNumber = $row1["registerLetter"] . '-' . $row1["RegistrationNo"];
                            ...
                            echo $timeSlotName = $row2["TimeSlotName"];
                            ...
                            echo $serviceName = $row3["ServiceName"];
